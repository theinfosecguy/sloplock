...
function buildProgram() {
    return new Command()
        ...
        .option("--ecosystem <ecosystem>", "ecosystem to scan: crates, npm, or pypi", parseEcosystem)
...
function parseEcosystem(value) {
    if (value === "crates" || value === "npm" || value === "pypi") {
        return value;
    }
    throw new InvalidArgumentError("must be crates, npm, or pypi.");
}
