...
export type DependencyReference = {
    ...
    isDirect: boolean;
    registrySource?: "known-public" | "ambiguous-custom-repository" | "ambiguous-lockfile-source";
};
...
export type RegistryPackageFailure = {
    status: "rate_limited" | "network_error" | "server_error" | "invalid_response" | "unsupported";
    ecosystem: Ecosystem;
    name: string;
    message: string;
    retryable: boolean;
};
export type RegistryResult = RegistryPackageFound | RegistryPackageNotFound | RegistryPackageFailure;
